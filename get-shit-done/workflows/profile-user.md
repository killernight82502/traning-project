...
Key references:
- @D:/b_hRYtXl5cj58-1774074657107/get-shit-done/references/ui-brand.md (display patterns)
- @D:/b_hRYtXl5cj58-1774074657107/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/b_hRYtXl5cj58-1774074657107/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/b_hRYtXl5cj58-1774074657107/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/b_hRYtXl5cj58-1774074657107/get-shit-done/USER-PROFILE.md" "D:/b_hRYtXl5cj58-1774074657107/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/b_hRYtXl5cj58-1774074657107/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/b_hRYtXl5cj58-1774074657107/get-shit-done/references/user-profiling.md`
...
Reference: @D:/b_hRYtXl5cj58-1774074657107/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/b_hRYtXl5cj58-1774074657107/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to D:/b_hRYtXl5cj58-1774074657107/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/b_hRYtXl5cj58-1774074657107/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/b_hRYtXl5cj58-1774074657107/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/b_hRYtXl5cj58-1774074657107/.clinerules"
...
```bash
BACKUP_PATH="D:/b_hRYtXl5cj58-1774074657107/USER-PROFILE.backup.md"
```
...
Your profile:    D:/b_hRYtXl5cj58-1774074657107/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/b_hRYtXl5cj58-1774074657107/commands/gsd/dev-preferences.md
  ✓ .clinerules section       .clinerules
  ✓ Global .clinerules        D:/b_hRYtXl5cj58-1774074657107/.clinerules
```
