...
```bash
node "D:/b_hRYtXl5cj58-1774074657107/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/b_hRYtXl5cj58-1774074657107/get-shit-done/templates/retrospective.md`.
