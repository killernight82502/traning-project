...
- **Global scope**: `D:/b_hRYtXl5cj58-1774074657107/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/b_hRYtXl5cj58-1774074657107/notes/`)
...
2. Glob `D:/b_hRYtXl5cj58-1774074657107/notes/*.md` (if directory exists) — global notes
...
Global (D:/b_hRYtXl5cj58-1774074657107/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/b_hRYtXl5cj58-1774074657107/notes/` — works in any directory
