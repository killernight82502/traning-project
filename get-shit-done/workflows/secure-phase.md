...
```
Task(
  prompt="Read D:/b_hRYtXl5cj58-1774074657107/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/b_hRYtXl5cj58-1774074657107/get-shit-done/templates/SECURITY.md`
