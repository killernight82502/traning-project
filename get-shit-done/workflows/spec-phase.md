...
```bash
INIT=$(node "D:/b_hRYtXl5cj58-1774074657107/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/b_hRYtXl5cj58-1774074657107/get-shit-done/templates/spec.md.
